...
export const StorePage = () => {
  ...
  return (
    <div className="relative flex flex-1 flex-col overflow-hidden bg-bg-base">
      ...
      <div className="sticky top-0 z-40 flex items-center space-x-3 border-b border-border-light bg-bg-base/95 px-4 pb-2.5 backdrop-blur" style={{ paddingTop: 'calc(var(--safe-top, 0px) + 10px)' }}>
