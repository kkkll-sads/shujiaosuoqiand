...
export const FavoritesPage = () => {
    ...
    <div className="bg-white dark:bg-gray-900 z-40 relative shrink-0 border-b border-gray-100 dark:border-gray-800">
      <div className="h-11 flex items-center justify-between px-3">
        ...
        <div className="w-1/3 flex justify-end">
          {(!empty && !loading && !error) && (
            <button onClick={toggleEdit} className="text-[14px] text-gray-600 dark:text-gray-400 dark:text-gray-500 px-2 py-1 active:opacity-70">
              {isEditing ? '完成' : '编辑'}
            </button>
          )}
        </div>
  ...
  const renderEmpty = () => (
    <div className="flex-1 flex flex-col items-center justify-center p-6 text-center">
      ...
      <p className="text-[13px] text-gray-500 dark:text-gray-400 dark:text-gray-500 mb-6">您还没有收藏任何商品哦</p>
      <button 
